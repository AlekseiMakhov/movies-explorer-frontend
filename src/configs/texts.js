...
export const aboutProjectSub2 = 'На выполнение диплома ушло 5 недель';
export const aboutProjectText1 = 'Составление плана, работу над бэкендом, вёрстку, добавление функциональности и финальные доработки.';
export const aboutProjectText2 = 'У каждого этапа был мягкий и жёсткий дедлайн, которые нужно было соблюдать, чтобы успешно защититься.';
